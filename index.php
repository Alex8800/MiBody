...
<div id="err" style="position:absolute; z-index: 1; top: 10px; left: 40px; font-weight: bold; font-size: 18px; color: red; display: none"></div>
<!-- Auhentication -->
...
<div class="container content center padding-64" style="max-width:800px" id="aboutUs">
    ...
    <center>
        <div class="profile">
            <p>Miriam Pleșa</p>
            <center><img src="Assets/Images/profile/profile.jpeg" alt="Avatar" style="width: 50px; height: 50px; border-radius: 50%"></center>
        </div>
    </center>
</div>
...
<div class="container content padding-64" style="max-width:800px" id="contact">
    ...
    <div class="row padding-32">
        ...
        <div class="col m6" id="commentForm">
            <form action="mailto:plesamiriam@yahoo.com"
             target="_blank">
            <div class="row-padding" style="margin:0 -16px 8px -16px">
                <div class="half">
                    <input class="input border"  style="color: red" type="text" readonly placeholder="Im Mail App ausfüllen."
                           name="Name">
                </div>
                <div class="half">
                    <input class="input border" type="text" readonly placeholder="Automatisch ausgefüllt"
                           name="Email">
                </div>
            </div>
            <input class="input border" type="text" readonly placeholder="Kommentar wird im Mail App geschrieben."
                   name="Message">
            <button class="button black section right" type="submit">Mail öffnen</button>
            </form>
        </div>
    </div>
</div>
...
<div class="container content" style="max-width:2000px" id="mapImage">
    <a href="https://www.google.com/maps/place/Faculty+of+Mathematics+and+Computer+Sciences/@45.6481138,25.587205,15z/data=!4m9!1m2!2m1!1sunitbv+iuliu+maniu!3m5!1s0x40b35b818c6b2a31:0xc0c8d417b1c86214!8m2!3d45.6492669!4d25.6014991!15sChJ1bml0YnYgaXVsaXUgbWFuaXWSAQp1bml2ZXJzaXR5"><img src="Assets/Images/images_png/location.png" style="width: 100%;"></a>
</div>
...
<script>
    ...
    function toggleFullScreen() {
        if (fullScreen === true) {
            document.getElementById("discoverContent").classList.remove('full-screen');
            document.getElementById("discoverContent").classList.add('modal-content');
            document.getElementById("discoverContent").style.height = (aux - 220) + 'px';
            document.getElementById('discoverMode').style.paddingTop = '100px';
            document.getElementById('discoverFrame').style.height = (aux - 340) + 'px'
            fullScreen = false;
        } else {
            document.getElementById("discoverContent").classList.remove('modal-content');
            document.getElementById("discoverContent").classList.add('full-screen');
            document.getElementById('discoverMode').style.paddingTop = '0px';
            document.getElementById('discoverFrame').style.height = (aux - 120) + 'px';
            document.getElementById("discoverContent").style.height = (aux)+ 'px';
            fullScreen = true;
        }
    }
